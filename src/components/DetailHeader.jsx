...
function DetailHeader() {
  return (
    <div className='w-[100%]  bg-black fixed z-[100]'>
        ...
        <div className='flex gap-[20px]'>
            <div className=' flex items-center gap-[10px] border-[2px] border-white px-4 rounded-2xl '>
                <IoSearch size={20}/>
                <input type="text" className='text-white  px-2 outline-none placeholder-gray-400' placeholder='Search for Games' />
            </div>
            <Link to={"/whislist"} className='ubisoft-bold text-[14px] hover:bg-[#6f6e6e]/60  px-3 rounded-xl py-2 flex gap-[10px] items-center'> <FaRegHeart /> Whislist</Link>
            <Link to={"/cart"} className='ubisoft-bold text-[14px] hover:bg-[#6f6e6e]/60  px-3 rounded-xl py-2 flex gap-[10px] items-center'> <LuShoppingCart  /> Cart</Link>
